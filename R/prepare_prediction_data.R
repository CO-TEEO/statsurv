...
#'   removed or NA'd out of the training data. Follows the `tidy-select` principles of the
#'   tidyverse.
...
#' prepare_training_data(spacetime_data, y, split_id = 9)
#'
#' # NA-out multiple columns
#' prepare_training_data(spacetime_data, c(y, y2), split_id = 9)
#'
#' # We can use dplyr selection helpers
#' prepare_training_data(spacetime_data, dplyr::starts_with("y"), split_id = 9)
#'
#' # Remove all rows above split_id
#' prepare_training_data(spacetime_data, y, split_id = 9, prep_strategy = "truncate")
prepare_training_data <- function(spacetime_data, outcome_cols, split_id,
